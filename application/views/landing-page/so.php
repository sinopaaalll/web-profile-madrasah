                            ...
                            <div class="col-lg-12 mb-2">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a class="text-dark">Struktur Organisasi</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title">Struktur Organisasi Madrasah Ibtidaiyah Al Amanah</h3>
                                        <hr>
                                        <div class="row justify-content-between">
                                        ...
                                        <hr>
                                        <img src="<?= base_url('assets/uploads/so/' . $profil->so) ?>" alt="" width="100%">
