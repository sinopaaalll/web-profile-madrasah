                    ...
                    <div class="section_title_container">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title">Visi Misi Madrasah Ibtidaiyah Al Amanah</h3>
                                        <hr>
                                        <div class="row justify-content-between">
                                        ...
                                        <hr>
                                        <div class="section_subtitle">Visi</div><br>
                                        <?= html_entity_decode($profil->visi) ?>
                                        <br>
                                        <div class="section_subtitle">Misi</div><br>
                                        <?= html_entity_decode($profil->misi) ?>
