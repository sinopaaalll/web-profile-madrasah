                ...
                <div class="col-sm-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"> Kelola Slider </h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    foreach ($slider as $data) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="fancybox" rel="ligthbox" href="<?= base_url('assets/uploads/slider/') . $data->slider ?>" title="<?= $data->keterangan ?>">
                                                    <img src="<?= base_url('assets/uploads/slider/') . $data->slider ?>" alt="Slider" style="width: 150px;">
                                                </a>
                                            </td>
                                            <td>
                                                <button type="button" data-toggle="modal" data-target="#modal-edit" data-id="<?= $data->id ?>" data-old-slider="<?= $data->slider ?>" data-ket="<?= $data->keterangan ?>" class="btn btn-sm btn-default edit-button"><span class="fas fa-edit"></span> Edit</button>

                                                <?php if (count($slider) > 1) : ?>
                                                    <a href="<?= base_url('admin/slider/hapus/' . $data->id) ?>" class="btn btn-sm btn-default btn-hapus" data-id="<?= $data->id ?>"><span class="fas fa-trash"></span> Hapus</a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
